...
const AccordionItem = ({ title, content, image, isActive, onClick }) => (
  <div className="my-4 max-w-[600px]  border border-gray-300">
    <div className="uppercase flex items-center justify-between span border-b-[1px] p-4 cursor-pointer" onClick={onClick}>
      <span className="flex items-center">
        <img src={image} alt="Icon" className="mr-4" />
        {title}
      </span>
      <span className={`transition duration-500 transform ${isActive ? 'rotate-180' : ''}`}>
