...
const Map = () => {
  ...
  return (
    <>
      <section onClick={togglePopup} className="bg-map-bg bg-cover xl:bg-options flex justify-center items-center flex-col  cursor-pointer hover:opacity group" aria-label="Open map" title="Open map">
