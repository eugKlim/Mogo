  ...
  return (
    <div className="container pt-16 pb-20 flex justify-center flex-wrap space-x-12 sm:flex-wrap-reverse">
          ...
          {infoBlogsData.map((data, index) => {
            return (
              <a href="#" className="flex items-center mb-5" key={index} aria-label={data.title}>
                ...
                <div className="ml-3">
                  <h4 className="uppercase text-gray-500 mb-2">{data.title}</h4>
      ...
      <section className="mb-10">
        ...
        <a href="#" className="font-RobotoLightItalic text-slate-500 mt-3 inline-block" aria-label="View more photos">
          View more photos
        </a>
      </section>
      {/* / */}
