    ...
    <div className="pt-16 pb-20  dark:bg-slate-800 dark:text-white">
      <div className="container flex justify-center flex-wrap lg:space-x-12 sm:flex-wrap-reverse">
        ...
        <section className="xl:w-1/3 mb-10 md:max-w-2/4">
          <h2 className="font-MontserratBold text-4xl text-gray-500 dark:text-white">MoGo</h2>
          <p className="my-8 text-gray-500 font-RobotoRegular dark:text-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            ...
            <div className="flex items-center">
              ...
              <div className="space-x-1">
                {infoSocialData.map((data, index) => {
                  return (
                    <a href="#" className="inline-block p-2 bg-yellow-500 text-red-500 hover:bg-red-500 hover:text-white rounded-3xl" title={data.linkName} key={index} aria-label={data.linkName}>
                      {data.icon}
                    </a>
                  );
                })}
          ...
          <form className="mt-10 flex sm:flex-wrap md:flex-nowrap">
            <input type="text" className="border p-2 md:rounded-l-xl sm:w-full md:w-1/2 text-black" placeholder="Your Email..." />
        ...
        <section className="xl:w-1/3 mb-10">
          ...
          <div>
            {infoBlogsData.map((data, index) => {
              return (
                <a href="#" className="flex items-center mb-5" key={index} aria-label={data.title}>
                  <div>
                    <img src={data.image} alt="image" className="min-w-28" />
                  </div>
                  <div className="ml-3">
                    <h4 className="uppercase text-gray-500 mb-2 dark:text-white">{data.title}</h4>
                    <p className="font-RobotoLightItalic text-gray-400">{data.date}</p>
                  </div>
                </a>
              );
            })}
        ...
        <section className="mb-10">
          ...
          <a href="#" className="underline font-RobotoLightItalic text-slate-500 mt-3 inline-block dark:text-white" aria-label="View more photos">
            View more photos
          </a>
        </section>
        {/* / */}
